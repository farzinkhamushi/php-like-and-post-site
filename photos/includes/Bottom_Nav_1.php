<div class="btmcontainer">
    <btmNav class="box_shadow" style="z-index: 1100;">
        <button onclick="handelMove(0,0,80)" class="item" id="openProfileModal">
            <svg class="item-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <button onclick="handelMove(1,20,60)" class="item">
            <svg class="item-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                ...
                <path d="M15 3.5V7M15 17V11" stroke-width="1.5" stroke-linecap="round" />
                <path d="M9 20.5V17M9 7V13" stroke-width="1.5" stroke-linecap="round" />
            </svg>
            <span class="item-text">Likes</span>
        </button>
        <button onclick="handelMove(2,40,40)" class="item" id="openhomeModal">
            <svg class="item-svg item-svg-active" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span class="item-text item-text-active">Home</span>
        </button>
        <button onclick="handelMove(3,60,20)" class="item" id="openuploadModal">
            <svg class="item-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                ...
                <path
                    ...
                    stroke-width="2" />
                <path d="M14 6.5H21"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M17.5 3V10"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <span class="item-text">Post</span>
        </button>
        <button onclick="handelMove(4,80,0)" class="item" id="openexploreModal">
            <svg class="item-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div id="swimmer" class="swimmer" style="left: 40%;right: 40%;"></div>
    </btmNav>
</div>